...
- [ ] Пример использования QuestDB (examples/questdb_batch.rs)
...
## Следующие шаги
1. Добавить пример использования QuestDB (examples/questdb_batch.rs).
2. Реализовать ClickHouse по аналогии (чтение трейдов, запись свечей, интеграция в main.rs, пример).
